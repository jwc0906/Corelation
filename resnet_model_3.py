...
class Model:
    def __init__(self, sess):
        ...
        self.cov_loss_rate = 0.0001 # tf.train.exponential_decay(1.0, self.global_step, 5000, 0.1, staircase=True)
        ...
        self.optimizer = tf.train.MomentumOptimizer(learning_rate=self.learning_rate, momentum=0.9).minimize(self.full_loss, global_step=self.global_step)
